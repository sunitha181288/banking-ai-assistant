...
import { Upload, FileText, X, Database, DownloadCloud, Search, Cpu, MessageSquare } from "lucide-react";
...
export default function Sidebar({ documents, setDocuments, memoryItems }) {
  ...
  return (
    <aside className="hidden md:flex w-72 min-w-[288px] bg-gray-900 border-r border-gray-700 flex-col overflow-y-auto">
      {/* Upload */}
